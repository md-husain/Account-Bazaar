...
function Marketplace() {
 ...
 const [filters,setFilters] = useState({
  ...
  // get dummy listed data by store
  ...
  return (
    <div className='px-6 md:px-16 lg:px-24 xl:px-32'>
      ...
      <div className='relative flex items-center justify-between  gap-8 pb-8'>
      <FilterSidebar setFilters={setFilters} filters={filters} setShowFilterPhone={setShowFilterPhone} showFilterPhone={showFilterPhone}/>
       ...
       {filteredListings.sort((a,b)=>a.featured?-1:b.featured?1:0).map((l,idx)=>(
        <ListingCard listing={l} key={idx}/>
       ))}
       </div>
      </div>
    </div>
