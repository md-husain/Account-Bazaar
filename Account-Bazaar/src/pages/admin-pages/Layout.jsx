...
import AdminSidebar from "../../assets/admin-components/AdminSidebar";
import AdminNavbar from "../../assets/admin-components/AdminNavbar";
    ...
    if (isLoading) {
        return (
            <div className="flex items-center justify-center h-screen">
                <Loader2Icon className="h-7 w-7 text-indigo-500 animate-spin" />
            </div>
        );
    }
