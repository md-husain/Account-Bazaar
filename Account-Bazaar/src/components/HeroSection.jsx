            ...
            <div className=" relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-gray-800">
                ...
                <h1 className="text-4xl md:text-6xl font-semibold max-w-lg md:max-w-2xl text-center mt-4 leading-tight md:leading-tight">
                   Buy & Sell Your <span className="relative bg-gradient-to-r from-purple-700 to-[#764de1] bg-clip-text text-transparent">
                    ...
                    <span className='relative bg-gradient-to-r from-[#764de1] to-indigo-600 bg-clip-text text-transparent'>Accounts</span> Online.
                </h1>

                <p className="max-w-xl text-center text-base my-7">A secure platfrom to buy and sell Instagram, Youtube, X, Telegram, Facebook and more - fast, safe and hassle-free </p>
                ...
                <form onSubmit={onSubmitHandler} className='w-full flex justify-center group'>
                    <label className='border border-gray-400 rounded-md p-1 flex items-center w-full max-w-md'>
                        <input onChange={e => setInput(e.target.value)} value={input} type="text" placeholder='Account' className='pl-2 flex-1 outline-none' />
